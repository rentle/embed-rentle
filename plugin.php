 ...
 */
function embed_rentle_shop_block_block_init() {
	/**
...
add_action( 'init', 'embed_rentle_shop_block_block_init' );
...
// Include library
require_once plugin_dir_path( __FILE__ ) . 'library/embed-rentle-classes.php';
